      ...
      <div className="d-flex justify-content-center align-items-center flex-column px-4 py-5 text-center">
			...
			<div className="col-lg-8 mx-auto">
				...
				<div className="d-grid gap-2 d-sm-flex justify-content-sm-center">
					...
					<a href="https://github.com/whybruno/" target="_blank" type="button" className="btn btn-dark btn-sm px-4"><img className="me-2" src={CubeTwo} alt="" width="32" height="32" />GitHub</a>
					<a href="https://www.linkedin.com/in/whybruno/" target="_blank" type="button" className="btn btn-dark btn-sm px-4"><img className="me-2" src={CubeThree} alt="" width="32" height="32" />LinkedIn</a>
